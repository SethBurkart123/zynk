...
class TestCamelCaseModelParameters:
    ...
    def test_command_execution_accepts_snake_case_for_camel_case_model_fields(self):
        received_body = None
    ...
    def test_command_execution_with_camel_case_input(self):
    ...
    def test_nested_model_with_camel_case_input(self):
...
class TestMixedParameterTypes:
    ...
    def test_model_with_primitive_params(self):
...
class TestReturnValueSerialization:
    ...
    def test_return_model_serializes_to_snake_case(self):
    ...
    def test_return_list_of_models(self):
...
class TestEdgeCases:
    ...
    def test_model_with_field_alias(self):
...
class TestErrorHandling:
    ...
    def test_missing_required_camel_case_field(self):
    ...
    def test_wrong_type_for_camel_case_field(self):
